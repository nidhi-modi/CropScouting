...
export default class Scouting3 extends Component {
    ...
    setUpMiniBays = () => {
        ...
        if (!list.length) {
            ...
            if (list[0] === undefined) {
                ...
                this.setState({ miniBay1Scouting3: '' })


            } else {

                this.setState({ miniBay1Scouting3: list[0] })
            ...
            if (list[1] === undefined) {
                ...
                this.setState({ miniBay2Scouting3: '' })


            } else {

                this.setState({ miniBay2Scouting3: list[1] })
            ...
            if (list[2] === undefined) {
                ...
                this.setState({ miniBay3Scouting3: '' })


            } else {

                this.setState({ miniBay3Scouting3: list[2] })
            ...
            if (list[3] === undefined) {
                ...
                this.setState({ miniBay4Scouting3: '' })


            } else {

                this.setState({ miniBay4Scouting3: list[3] })
            ...
            if (list[4] === undefined) {
                ...
                this.setState({ miniBay5Scouting3: '' })


            } else {

                this.setState({ miniBay5Scouting3: list[4] })
            ...
            if (list[5] === undefined) {
                ...
                this.setState({ miniBay6Scouting3: '' })


            } else {

                this.setState({ miniBay6Scouting3: list[5] })
            ...
            if (list[6] === undefined) {
                ...
                this.setState({ miniBay7Scouting3: '' })


            } else {

                this.setState({ miniBay7Scouting3: list[6] })
            ...
            if (list[7] === undefined) {
                ...
                this.setState({ miniBay8Scouting3: '' })


            } else {

                this.setState({ miniBay8Scouting3: list[7] })
            ...
            if (list[8] === undefined) {
                ...
                this.setState({ miniBay9Scouting3: '' })


            } else {

                this.setState({ miniBay9Scouting3: list[8] })
            ...
            if (list[9] === undefined) {
                ...
                this.setState({ miniBay10Scouting3: '' })


            } else {

                this.setState({ miniBay10Scouting3: list[9] })
            ...
            if (list[10] === undefined) {
                ...
                this.setState({ miniBay11Scouting3: '' })


            } else {

                this.setState({ miniBay11Scouting3: list[10] })
    ...
    handleEmptyCells = () => {
        ...
        var bay1 = this.state.miniBay1Scouting3;
        var bay2 = this.state.miniBay2Scouting3;
        var bay3 = this.state.miniBay3Scouting3;
        var bay4 = this.state.miniBay4Scouting3;
        var bay5 = this.state.miniBay5Scouting3;
        var bay6 = this.state.miniBay6Scouting3;
        var bay7 = this.state.miniBay7Scouting3;
        var bay8 = this.state.miniBay8Scouting3;
        var bay9 = this.state.miniBay9Scouting3;
        var bay10 = this.state.miniBay10Scouting3;
        var bay11 = this.state.miniBay11Scouting3;
        ...
        if (h1 !== null && h2 === null && h3 === null && h4 === null || h1 !== "" && h2 === "" && h3 === "" && h4 === "") {
            ...
            if (bay1 !== '') {
                ...
                if (this.state.bay1Text1Scouting3 === null || this.state.bay1Text1Scouting3 === "") {
                    ...
                    this.setItem(this.state.Scouting3Type + "" + "bay1Text1Scouting3", '0')
            ...
            if (bay2 !== '') {
                ...
                if (this.state.bay2Text1Scouting3 === null || this.state.bay2Text1Scouting3 === "") {
                    ...
                    this.setItem(this.state.Scouting3Type + "" + "bay2Text1Scouting3", '0')
            ...
            if (bay3 !== '') {
                if (this.state.bay3Text1Scouting3 === null || this.state.bay3Text1Scouting3 === "") {
                    ...
                    this.setItem(this.state.Scouting3Type + "" + "bay3Text1Scouting3", '0')
            ...
            if (bay4 !== '') {
                ...
                if (this.state.bay4Text1Scouting3 === null || this.state.bay4Text1Scouting3 === "") {
                    ...
                    this.setItem(this.state.Scouting3Type + "" + "bay4Text1Scouting3", '0')
            ...
            if (bay5 !== '') {
                ...
                if (this.state.bay5Text1Scouting3 === null || this.state.bay5Text1Scouting3 === "") {
                    ...
                    this.setItem(this.state.Scouting3Type + "" + "bay5Text1Scouting3", '0')
            ...
            if (bay6 !== '') {
                ...
                if (this.state.bay6Text1Scouting3 === null || this.state.bay6Text1Scouting3 === "") {
                    ...
                    this.setItem(this.state.Scouting3Type + "" + "bay6Text1Scouting3", '0')
            ...
            if (bay7 !== '') {
                ...
                if (this.state.bay7Text1Scouting3 === null || this.state.bay7Text1Scouting3 === "") {
                    ...
                    this.setItem(this.state.Scouting3Type + "" + "bay7Text1Scouting3", '0')
            ...
            if (bay8 !== '') {
                ...
                if (this.state.bay8Text1Scouting3 === null || this.state.bay8Text1Scouting3 === "") {
                    ...
                    this.setItem(this.state.Scouting3Type + "" + "bay8Text1Scouting3", '0')
            ...
            if (bay9 !== '') {
                ...
                if (this.state.bay9Text1Scouting3 === null || this.state.bay9Text1Scouting3 === "") {
                    ...
                    this.setItem(this.state.Scouting3Type + "" + "bay9Text1Scouting3", '0')
            ...
            if (bay10 !== '') {
                ...
                if (this.state.bay10Text1Scouting3 === null || this.state.bay10Text1Scouting3 === "") {
                    ...
                    this.setItem(this.state.Scouting3Type + "" + "bay10Text1Scouting3", '0')
            ...
            if (bay11 !== '') {
                if (this.state.bay11Text1Scouting3 === null || this.state.bay11Text1Scouting3 === "") {
                    ...
                    this.setItem(this.state.Scouting3Type + "" + "bay11Text1Scouting3", '0')
            ...
            if (h1 !== null && h2 !== null && h3 === null && h4 === null || h1 !== "" && h2 !== "" && h3 === "" && h4 === "") {
                ...
                if (bay1 !== '') {
                    if (this.state.bay1Text2Scouting3 === null || this.state.bay1Text2Scouting3 === "") {
                        ...
                        this.setItem(this.state.Scouting3Type + "" + "bay1Text2Scouting3", '0')
                ...
                if (bay2 !== '') {
                    if (this.state.bay2Text2Scouting3 === null || this.state.bay2Text2Scouting3 === "") {
                        ...
                        this.setItem(this.state.Scouting3Type + "" + "bay2Text2Scouting3", '0')
                ...
                if (bay3 !== '') {
                    if (this.state.bay3Text2Scouting3 === null || this.state.bay3Text2Scouting3 === "") {
                        ...
                        this.setItem(this.state.Scouting3Type + "" + "bay3Text2Scouting3", '0')
                ...
                if (bay4 !== '') {
                    if (this.state.bay4Text2Scouting3 === null || this.state.bay4Text2Scouting3 === "") {
                        ...
                        this.setItem(this.state.Scouting3Type + "" + "bay4Text2Scouting3", '0')
                ...
                if (bay5 !== '') {
                    if (this.state.bay5Text2Scouting3 === null || this.state.bay5Text2Scouting3 === "") {
                        ...
                        this.setItem(this.state.Scouting3Type + "" + "bay5Text2Scouting3", '0')
                ...
                if (bay6 !== '') {
                    if (this.state.bay6Text2Scouting3 === null || this.state.bay6Text2Scouting3 === "") {
                        ...
                        this.setItem(this.state.Scouting3Type + "" + "bay6Text2Scouting3", '0')
                ...
                if (bay7 !== '') {
                    if (this.state.bay7Text2Scouting3 === null || this.state.bay7Text2Scouting3 === "") {
                        ...
                        this.setItem(this.state.Scouting3Type + "" + "bay7Text2Scouting3", '0')
                ...
                if (bay8 !== '') {
                    if (this.state.bay8Text2Scouting3 === null || this.state.bay8Text2Scouting3 === "") {
                        ...
                        this.setItem(this.state.Scouting3Type + "" + "bay8Text2Scouting3", '0')
                ...
                if (bay9 !== '') {
                    if (this.state.bay9Text2Scouting3 === null || this.state.bay9Text2Scouting3 === "") {
                        ...
                        this.setItem(this.state.Scouting3Type + "" + "bay9Text2Scouting3", '0')
                ...
                if (bay10 !== '') {
                    if (this.state.bay10Text2Scouting3 === null || this.state.bay10Text2Scouting3 === "") {
                        ...
                        this.setItem(this.state.Scouting3Type + "" + "bay10Text2Scouting3", '0')
                ...
                if (bay11 !== '') {
                    if (this.state.bay11Text2Scouting3 === null || this.state.bay11Text2Scouting3 === "") {
                        ...
                        this.setItem(this.state.Scouting3Type + "" + "bay11Text2Scouting3", '0')
                ...
                if (h1 !== null && h2 !== null && h3 !== null && h4 === null || h1 !== "" && h2 !== "" && h3 !== "" && h4 === "") {
                    ...
                    if (bay1 !== '') {
                        if (this.state.bay1Text3Scouting3 === null || this.state.bay1Text3Scouting3 === "") {
                            ...
                            this.setItem(this.state.Scouting3Type + "" + "bay1Text3Scouting3", '0')
                    ...
                    if (bay2 !== '') {
                        if (this.state.bay2Text3Scouting3 === null || this.state.bay2Text3Scouting3 === "") {
                            ...
                            this.setItem(this.state.Scouting3Type + "" + "bay2Text3Scouting3", '0')
                    ...
                    if (bay3 !== '') {
                        if (this.state.bay3Text3Scouting3 === null || this.state.bay3Text3Scouting3 === "") {
                            ...
                            this.setItem(this.state.Scouting3Type + "" + "bay3Text3Scouting3", '0')
                    ...
                    if (bay4 !== '') {
                        if (this.state.bay4Text3Scouting3 === null || this.state.bay4Text3Scouting3 === "") {
                            ...
                            this.setItem(this.state.Scouting3Type + "" + "bay4Text3Scouting3", '0')
                    ...
                    if (bay5 !== '') {
                        if (this.state.bay5Text3Scouting3 === null || this.state.bay5Text3Scouting3 === "") {
                            ...
                            this.setItem(this.state.Scouting3Type + "" + "bay5Text3Scouting3", '0')
                    ...
                    if (bay6 !== '') {
                        if (this.state.bay6Text3Scouting3 === null || this.state.bay6Text3Scouting3 === "") {
                            ...
                            this.setItem(this.state.Scouting3Type + "" + "bay6Text3Scouting3", '0')
                    ...
                    if (bay7 !== '') {
                        if (this.state.bay7Text3Scouting3 === null || this.state.bay7Text3Scouting3 === "") {
                            ...
                            this.setItem(this.state.Scouting3Type + "" + "bay7Text3Scouting3", '0')
                    ...
                    if (bay8 !== '') {
                        if (this.state.bay8Text3Scouting3 === null || this.state.bay8Text3Scouting3 === "") {
                            ...
                            this.setItem(this.state.Scouting3Type + "" + "bay8Text3Scouting3", '0')
                    ...
                    if (bay9 !== '') {
                        if (this.state.bay9Text3Scouting3 === null || this.state.bay9Text3Scouting3 === "") {
                            ...
                            this.setItem(this.state.Scouting3Type + "" + "bay9Text3Scouting3", '0')
                    ...
                    if (bay10 !== '') {
                        if (this.state.bay10Text3Scouting3 === null || this.state.bay10Text3Scouting3 === "") {
                            ...
                            this.setItem(this.state.Scouting3Type + "" + "bay10Text3Scouting3", '0')
                    ...
                    if (bay11 !== '') {
                        if (this.state.bay11Text3Scouting3 === null || this.state.bay11Text3Scouting3 === "") {
                            ...
                            this.setItem(this.state.Scouting3Type + "" + "bay11Text3Scouting3", '0')
                    ...
                    if (h1 !== null && h2 !== null && h3 !== null && h4 !== null || h1 !== "" && h2 !== "" && h3 !== "" && h4 !== "") {
                        ...
                        if (bay1 !== '') {
                            if (this.state.bay1Text4Scouting3 === null || this.state.bay1Text4Scouting3 === "") {
                                ...
                                this.setItem(this.state.Scouting3Type + "" + "bay1Text4Scouting3", '0')
                        ...
                        if (bay2 !== '') {
                            if (this.state.bay2Text4Scouting3 === null || this.state.bay2Text4Scouting3 === "") {
                                ...
                                this.setItem(this.state.Scouting3Type + "" + "bay2Text4Scouting3", '0')
                        ...
                        if (bay2 !== '') {
                            if (this.state.bay3Text4Scouting3 === null || this.state.bay3Text4Scouting3 === "") {
                                ...
                                this.setItem(this.state.Scouting3Type + "" + "bay3Text4Scouting3", '0')
                        ...
                        if (bay4 !== '') {
                            if (this.state.bay4Text4Scouting3 === null || this.state.bay4Text4Scouting3 === "") {
                                ...
                                this.setItem(this.state.Scouting3Type + "" + "bay4Text4Scouting3", '0')
                        ...
                        if (bay5 !== '') {
                            if (this.state.bay5Text4Scouting3 === null || this.state.bay5Text4Scouting3 === "") {
                                ...
                                this.setItem(this.state.Scouting3Type + "" + "bay5Text4Scouting3", '0')
                        ...
                        if (bay6 !== '') {
                            if (this.state.bay6Text4Scouting3 === null || this.state.bay6Text4Scouting3 === "") {
                                ...
                                this.setItem(this.state.Scouting3Type + "" + "bay6Text4Scouting3", '0')
                        ...
                        if (bay7 !== '') {
                            if (this.state.bay7Text4Scouting3 === null || this.state.bay7Text4Scouting3 === "") {
                                ...
                                this.setItem(this.state.Scouting3Type + "" + "bay7Text4Scouting3", '0')
                        ...
                        if (bay8 !== '') {
                            if (this.state.bay8Text4Scouting3 === null || this.state.bay8Text4Scouting3 === "") {
                                ...
                                this.setItem(this.state.Scouting3Type + "" + "bay8Text4Scouting3", '0')
                        ...
                        if (bay9 !== '') {
                            if (this.state.bay9Text4Scouting3 === null || this.state.bay9Text4Scouting3 === "") {
                                ...
                                this.setItem(this.state.Scouting3Type + "" + "bay9Text4Scouting3", '0')
                        ...
                        if (bay10 !== '') {
                            if (this.state.bay10Text4Scouting3 === null || this.state.bay10Text4Scouting3 === "") {
                                ...
                                this.setItem(this.state.Scouting3Type + "" + "bay10Text4Scouting3", '0')
                        ...
                        if (bay11 !== '') {
                            if (this.state.bay11Text4Scouting3 === null || this.state.bay11Text4Scouting3 === "") {
                                ...
                                this.setItem(this.state.Scouting3Type + "" + "bay11Text4Scouting3", '0')
    ...
    saveScoutingDetails2 = () => {
        ...
        if (this.state.miniBay2Scouting3 !== null) {
            ...
            let data2 = {
                ...
                header3: this.state.header3Scouting3,
                header4: this.state.header4Scouting3,
                miniBay: this.state.miniBay2Scouting3,
    ...
    saveScoutingDetails3 = () => {
        ...
        if (this.state.miniBay3Scouting3 !== null) {
            ...
            let data3 = {
                ...
                header3: this.state.header3Scouting3,
                header4: this.state.header4Scouting3,
                miniBay: this.state.miniBay3Scouting3,
    ...
    saveScoutingDetails4 = () => {
        ...
        if (this.state.miniBay4Scouting3 !== null) {
            ...
            let data4 = {
                ...
                header3: this.state.header3Scouting3,
                header4: this.state.header4Scouting3,
                miniBay: this.state.miniBay4Scouting3,
    ...
    saveScoutingDetails5 = () => {
        ...
        if (this.state.miniBay5Scouting3 !== null) {
            ...
            let data5 = {
                ...
                header3: this.state.header3Scouting3,
                header4: this.state.header4Scouting3,
                miniBay: this.state.miniBay5Scouting3,
    ...
    saveScoutingDetails6 = () => {
        ...
        if (this.state.miniBay6Scouting3 !== null) {
            ...
            let data6 = {
                ...
                header3: this.state.header3Scouting3,
                header4: this.state.header4Scouting3,
                miniBay: this.state.miniBay6Scouting3,
    ...
    saveScoutingDetails7 = () => {
        ...
        if (this.state.miniBay7Scouting3 !== null) {
            ...
            let data7 = {
                ...
                header3: this.state.header3Scouting3,
                header4: this.state.header4Scouting3,
                miniBay: this.state.miniBay7Scouting3,
    ...
    saveScoutingDetails8 = () => {
        ...
        if (this.state.miniBay8Scouting3 !== null) {
            ...
            let data8 = {
                ...
                header3: this.state.header3Scouting3,
                header4: this.state.header4Scouting3,
                miniBay: this.state.miniBay8Scouting3,
    ...
    saveScoutingDetails9 = () => {
        ...
        if (this.state.miniBay9Scouting3 !== null) {
            ...
            let data9 = {
                ...
                header3: this.state.header3Scouting3,
                header4: this.state.header4Scouting3,
                miniBay: this.state.miniBay9Scouting3,
    ...
    saveScoutingDetails10 = () => {
        ...
        if (this.state.miniBay10Scouting3 !== null) {
            ...
            let data10 = {
                ...
                header3: this.state.header3Scouting3,
                header4: this.state.header4Scouting3,
                miniBay: this.state.miniBay10Scouting3,
    ...
    saveScoutingDetails11 = () => {
        ...
        if (this.state.miniBay11Scouting3 !== null) {
            ...
            let data11 = {
                ...
                header3: this.state.header3Scouting3,
                header4: this.state.header4Scouting3,
                miniBay: this.state.miniBay11Scouting3,
                        ...
                        <View pointerEvents={this.state.dataEntered == "Yes" ? 'none' : 'auto'}>
                            ...
                            <View style={styles.mainPageContainer}>
                                ...
                                <View style={styles.tableContainer}>
                                    ...
                                    <View style={styles.tableRow}>
                                        <View style={styles.tableColumnClockInOutTimes}>
                                            <Text style={styles.textLineItemGreen}>{this.state.miniBay1Scouting3}</Text>
                                        </View>
                                    ...
                                    <View style={styles.tableRow}>
                                        <View style={styles.tableColumnClockInOutTimes}>
                                            <Text style={styles.textLineItemGreen}>{this.state.miniBay2Scouting3}</Text>
                                        </View>
                                    ...
                                    <View style={styles.tableRow}>
                                        <View style={styles.tableColumnClockInOutTimes}>
                                            <Text style={styles.textLineItemGreen}>{this.state.miniBay3Scouting3}</Text>
                                        </View>
                                    ...
                                    <View style={styles.tableRow}>
                                        <View style={styles.tableColumnClockInOutTimes}>
                                            <Text style={styles.textLineItemGreen}>{this.state.miniBay4Scouting3}</Text>
                                        </View>
                                    ...
                                    <View style={styles.tableRow}>
                                        <View style={styles.tableColumnClockInOutTimes}>
                                            <Text style={styles.textLineItemGreen}>{this.state.miniBay5Scouting3}</Text>
                                        </View>
                                    ...
                                    <View style={styles.tableRow}>
                                        <View style={styles.tableColumnClockInOutTimes}>
                                            <Text style={styles.textLineItemGreen}>{this.state.miniBay6Scouting3}</Text>
                                        </View>
                                    ...
                                    <View style={styles.tableRow}>
                                        <View style={styles.tableColumnClockInOutTimes}>
                                            <Text style={styles.textLineItemGreen}>{this.state.miniBay7Scouting3}</Text>
                                        </View>
                                    ...
                                    <View style={styles.tableRow}>
                                        <View style={styles.tableColumnClockInOutTimes}>
                                            <Text style={styles.textLineItemGreen}>{this.state.miniBay8Scouting3}</Text>
                                        </View>
                                    ...
                                    <View style={styles.tableRow}>
                                        <View style={styles.tableColumnClockInOutTimes}>
                                            <Text style={styles.textLineItemGreen}>{this.state.miniBay9Scouting3}</Text>
                                        </View>
                                    ...
                                    <View style={styles.tableRow}>
                                        <View style={styles.tableColumnClockInOutTimes}>
                                            <Text style={styles.textLineItemGreen}>{this.state.miniBay10Scouting3}</Text>
                                        </View>
                                    ...
                                    <View style={styles.tableRow}>
                                        <View style={styles.tableColumnClockInOutTimes}>
                                            <Text style={styles.textLineItemGreen}>{this.state.miniBay11Scouting3}</Text>
                                        </View>
